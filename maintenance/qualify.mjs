...
const {createJSONataExecutor}=require('@openbindings/jsonata');
const {createNodeExecutor}=require('@openbindings/jsonata/node');
const direct=createJSONataExecutor({timeout:5000}),worker=createNodeExecutor({timeout:5000,workers:1});
