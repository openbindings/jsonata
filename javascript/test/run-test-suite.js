...
var applyOfficialExpectation = require('./official-expectations');
var applyDocumentationExpectation = require('./documentation-expectations');
        ...
        filenames.forEach(name => {
            ...
            if(Array.isArray(spec)) {
                spec.forEach((item, index) => {
                    applyDocumentationExpectation(group + '/' + name, index, item);
                    if(!item.description) {
                ...
                applyOfficialExpectation(group + '/' + name, spec);
                if(!spec.description) {
